			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
							<a href="{{URL('users/blog-detail')}}" class="hov-img0 how-pos5-parent">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="{{URL('users/blog-detail')}}" class="ltext-108 cl2 hov-cl1 trans-04">
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="{{URL('users/blog-detail')}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
				...
				<div class="col-md-4 col-lg-3 p-b-80">
					<div class="side-menu">
						...
						<div class="p-t-55">
							...
							<ul>
								<li class="bor18">
									<a href="{{URL('users/#')}}" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">
										Fashion
									</a>
								</li>
						...
						<div class="p-t-65">
							...
							<ul>
								<li class="flex-w flex-t p-b-30">
									<a href="{{URL('users/#')}}" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="{{asset('images/product-min-01.jpg')}}" alt="PRODUCT">
									</a>

									<div class="size-215 flex-col-t p-t-8">
										<a href="{{URL('users/#')}}" class="stext-116 cl8 hov-cl1 trans-04">
						...
						<div class="p-t-55">
							...
							<ul>
								<li class="p-b-7">
									<a href="{{URL('users/#')}}" class="flex-w flex-sb-m stext-115 cl6 hov-cl1 trans-04 p-tb-2">
										<span>
											July 2018
										</span>
